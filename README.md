...
│   └── js/
│       └── manutencao.js      # Interação do cursor na página de manutenção
...
- **Manutenção:** edite `manutencao.html`, `assets/css/manutencao.css` e `assets/js/manutencao.js`. A página usa Google Fonts e mantém a configuração `noindex, nofollow`.
